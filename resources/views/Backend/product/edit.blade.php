    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                ...
                <form role="form" method="POST" action="{{route('Backend.Product.update')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                        ...
                        <div class="tab-pane fade show active" id="seo" role="tabpanel" aria-labelledby="tab-outline-one">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="title" name="title" type="text" value="{{$data->title}}" class="form-control form-control-sm">
                                </div>
                                <div class="form-group">
                                    <label for="keywords">Keywords</label>
                                    <textarea class="form-control" name="keywords" id="keywords" rows="3">{{$data->keywords}}</textarea>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="tab-pane fade" id="detail" role="tabpanel" aria-labelledby="tab-outline-one">
                            <div class="card-body">
                                ...
                                <div class="box">
                                    ...
                                    <label for="images"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"></path></svg> <span>Upload image</span>
                                    <img src="{{asset('upload/product/')}}/{{$data->images}}" alt="{{$data->images}}" width="300"></label>
                                </div>
                                <div class="form-group">
                                    <label for="name_vi" class="col-form-label">Name</label>
                                    <input id="name_vi" name='name_vi' value="{{$data->name_vi}}" type="text" class="form-control" required>
                                </div>

                                <div class="form-group">
                                    <label for="code" class="col-form-label">Code product</label>
                                    <input id="code" name='code' value="{{$data->code}}" type="text" class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="price" class="col-form-label">Price</label>
                                    <input id="price" name='price' value="{{$data->price}}" type="text" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="quantity" class="col-form-label">Quantity</label>
                                    <input id="quantity" name='quantity' value="{{$data->quantity}}" type="number" class="form-control">
                                </div>


                                <div class="form-group">
                                    <label for="description_vi">Description</label>
                                    <textarea class="form-control"  name="description_vi" id="description_vi" rows="3">{{$data->description_vi}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="content_vi">Content</label>
                                    <textarea class="form-control" name="content_vi" id="content_vi" rows="3">{{$data->content_vi}}</textarea>
                                </div>
